...
protected:
    ...
    std::function<bool(DWORD keyCode, bool down, DWORD flags)> keyHandler;
    bool visible = false;
...
public:
    ...
    void onKey(std::function<bool(DWORD keyCode, bool down, DWORD flags)> handler);
    ...
    virtual bool interactKey(DWORD keyCode, bool down, DWORD flags);
};
